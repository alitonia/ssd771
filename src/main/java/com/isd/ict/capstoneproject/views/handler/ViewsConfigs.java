...
public class ViewsConfigs {
    ...
    // resources config
    public static String IMAGE_PATH = "src/main/resources/images/";
    public static String SPLASH_SCREEN_PATH = "views/fxml/splash.fxml";
    public static String RENT_BIKE_SCREEN_PATH = "views/fxml/rent-new-bike.fxml";
    public static String HOME_DOCK_LIST_SCREEN_PATH = "views/fxml/home-station-list.fxml";
    public static String VIEW_RENTAL_SCREEN_PATH = "views/fxml/view-rental.fxml";
    public static String INVOICE_SCREEN_PATH = "views/fxml/invoice.fxml";
    public static String DOCK_DETAIL_SCREEN_PATH = "views/fxml/station-details.fxml";
