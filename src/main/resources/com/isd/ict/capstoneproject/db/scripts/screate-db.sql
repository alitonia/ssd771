...
CREATE UNIQUE INDEX "BikeType.FK_BikeType_bikeTypeName1_idx" ON "BikeType" ("bikeTypeName");
...
CREATE FULLTEXT INDEX "Station.FK_Station_name1_idx" ON "Station" ("name");
CREATE FULLTEXT INDEX "Station.FK_Station_address1_idx" ON "Station" ("address");
...
CREATE UNIQUE INDEX "Invoice.FK_Invoice_typeRentalId1_idx" ON "Invoice" ("type", "rentalId");